function q2
	...
	SurfPlot(S, Time, U, 'S', 't', 'u(S, t)', 'FTCS Surface Plot', 'q2_FTCS');
    ...
    for method = Methods
	    ...
	    SurfPlot(S, Time, U, 'S', 't', 'u(S, t)', ['BTCS Line Plot using ' method], strcat('q2_BTCS_', method));
	    ...
	    SurfPlot(S, Time, U, 'S', 't', 'u(S, t)', ['Crank-Nicolson Line Plot using ' method], strcat('q2_CN_', method));
